...
# Node.js (via nvm), yarn and pnpm (node-nvm-use)
...
```json
"features": {
    "ghcr.io/alchemicalartist/node-nvm-use/node-nvm-use:1": {}
}
```
...
| addNvmUse | Enable nvm use on cd | boolean | true |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/alchemicalartist/node-nvm-use/blob/main/src/node-nvm-use/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
